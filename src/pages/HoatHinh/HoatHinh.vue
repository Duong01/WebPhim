              ...
              >
                ...
                <v-card-text class="movie-info">
                  ...
                  <div class="meta-row">
                    ...
                    <span v-if="movie.time" class="text-truncate">{{ movie.time }}</span>
                    <span v-if="movie.country && movie.country[0]">•</span>
                    <span v-if="movie.country && movie.country[0]" class="text-truncate">{{ movie.country[0].name }}</span>
                  </div>

                  <div class="genre-list" v-if="movie.category">
                    <span v-for="c in movie.category.slice(0,2)" :key="c.id || c.name" class="genre-item">
                      {{ c.name }}
                    </span>
                  </div>
                </v-card-text>
